...
export default function TopNav({ currentPageName }) {
  return (
    <header className="bg-[hsl(var(--background))] px-4 rounded-[0px_0px_4px_4px] fixed top-0 left-0 right-0 z-50 h-12 border-b border-gray-200 flex items-center gap-1">
      {/* Brand */}
      <Link
