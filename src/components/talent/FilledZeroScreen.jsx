...
export default function FilledZeroScreen() {
  return (
    <div className="mb-20 pt-48 pr-8 pb-64 pl-8 text-center flex flex-col items-center justify-center h-full w-full">
      <div className="bg-slate-300 mb-5 rounded-full w-20 h-20 flex items-center justify-center">
        <Globe className="lucide lucide-globe lucide lucide-globe lucide lucide-globe w-8 h-8 text-white" />
      </div>
