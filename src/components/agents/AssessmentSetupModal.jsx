...
import { X, Sparkles, FileText, PenLine, ChevronRight, ChevronLeft, Check, Mail, Clock, Shield, Bot, AlertTriangle, Eye, Loader2, Plus, Trash2, Filter, ExternalLink, Share2, CheckCircle2 } from "lucide-react";
  ...
  if (!initiated) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-[75rem] mx-4 overflow-hidden flex" style={{ height: "700px" }}>
          {/* Left — gradient hero panel */}
          <div className="w-[42%] shrink-0 bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-700 flex flex-col justify-between px-10 py-10 relative overflow-hidden">
            {/* subtle bg circles */}
            ...
            <div className="relative z-10">
              ...
              <span className="text-[11px] font-bold uppercase tracking-widest text-blue-200 mb-3 block">Assessment Agent</span>
              <h2 className="text-[32px] font-bold text-white leading-tight mb-4">Automate your entire assessment pipeline</h2>
              <p className="text-[14px] text-blue-100 leading-relaxed">
                From smart invites to AI-powered scoring — set up once and let the agent handle the rest.
              </p>
            </div>
          ...
          <div className="flex-1 flex flex-col justify-center px-12 py-10 relative">
            <button onClick={onClose} className="absolute top-5 right-5 w-8 h-8 rounded-lg bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors">
