        ...
        <div className="flex items-center gap-2">
          ...
          <div className="bg-slate-200 p-1 rounded-full flex items-center gap-1">
            ...
            <Button
              ...
              title={view.label} className={`h-8 w-8 p-0 rounded-full transition-all duration-200 ${viewMode === view.key ? "bg-white text-gray-900 shadow-sm" : "text-gray-400 hover:text-gray-600"}`}>
