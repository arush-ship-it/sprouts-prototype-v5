    ...
    <div className="px-8 py-2">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          <Button
            variant="ghost"
            size="sm" className="bg-[hsl(var(--background))] text-gray-700 px-3 py-1.5 text-xs font-medium rounded-lg border-gray-200 h-8 inline-flex items-center justify-center gap-0 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:text-accent-foreground hover:bg-gray-200">
