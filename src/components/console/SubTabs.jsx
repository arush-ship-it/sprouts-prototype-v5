    ...
    <div className="px-8 py-2">
      <div className="flex items-center justify-between">
        <div className="bg-slate-200 p-1 rounded-[28px] flex items-center gap-1 w-fit">
          ...
          <button
            key={tab.key}
            onClick={() => setActiveTab(tab.key)} className="bg-white text-gray-900 px-5 py-2 text-xs font-medium rounded-3xl relative transition-all duration-300 flex items-center gap-2 shadow-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            variant="ghost"
            size="sm" className="bg-[#F2F3F5] text-gray-700 px-3 text-xs font-medium rounded-lg inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:text-accent-foreground h-10 hover:bg-gray-200">
