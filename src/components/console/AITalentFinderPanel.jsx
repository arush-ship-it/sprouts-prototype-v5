...
export default function AITalentFinderPanel() {
  ...
  return (
    <div className="bg-white mt-2 mr-2 ml-2 rounded-3xl border-r border-gray-200 flex flex-col overflow-hidden transition-all duration-300 w-[400px]" style={{ height: "calc(100vh - 80px)" }}>
      {/* Top Tabs */}
