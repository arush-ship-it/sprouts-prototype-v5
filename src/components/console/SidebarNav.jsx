...
export default function SidebarNav({ activePage = "Console" }) {
  ...
  return (
    <aside className="bg-[#ededed] mx-2 my-2 px-4 py-6 rounded-2xl w-[260px] h-screen flex flex-col fixed left-0 top-0 shrink-0 border-r border-gray-200 overflow-hidden">
