...
export default function SidebarNav({ activePage = "Console" }) {
  ...
  return (
    <aside className="bg-[#ededed] mx-2 my-2 px-3 py-6 rounded-lg w-[221px] flex flex-col fixed left-0 top-12 bottom-0 shrink-0 border-r border-gray-200 overflow-hidden">
