...
export default function SidebarNav({ activePage = "Console" }) {
  ...
  return (
    <aside className="bg-[#E5E7EB] mx-3 my-3 px-3 rounded-xl w-[221px] flex flex-col fixed left-0 top-12 bottom-0 shrink-0 border-r border-gray-200 overflow-hidden">
