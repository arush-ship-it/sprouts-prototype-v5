    ...
    <aside className="bg-[#E5E7EB] mt-3 mr-3 mb-3 ml-3 pr-3 pl-3 rounded-xl w-[221px] flex flex-col fixed left-0 top-12 bottom-0 shrink-0 border-r border-gray-200 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <nav className="flex flex-col gap-1">
          ...
          <Link
            key={link.label}
            to={createPageUrl(link.page)} className="bg-white text-slate-700 px-3 py-2.5 font-medium rounded-lg flex items-center gap-3 transition-all duration-200 group">
