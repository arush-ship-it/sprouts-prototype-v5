...
import {
  ...
  ChevronUp, ChevronDown, Minimize2, Maximize2 } from
"lucide-react";
import { Button } from "@/components/ui/button";
import { Textarea } from "@/components/ui/textarea";
import {
  LineChart, Line, BarChart, Bar, PieChart as RechartsPieChart, Pie, Cell,
  XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, AreaChart, Area, RadialBarChart, RadialBar, FunnelChart, Funnel, LabelList } from
"recharts";
...
<div className="bg-[#ffffff] p-5 rounded-2xl border border-blue-100 flex flex-col gap-2">
