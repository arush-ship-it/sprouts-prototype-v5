          ...
          <>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex gap-2">
                  ...
                  <Button onClick={handleSendChat} size="icon" className="bg-blue-600 text-primary-foreground text-sm font-medium rounded-[32px] inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow hover:bg-primary/90 shrink-0 h-9 w-9">
