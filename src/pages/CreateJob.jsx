          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <div className="flex items-center gap-2.5 mb-6">
                <div className="bg-slate-400 rounded-3xl w-10 h-10 flex items-center justify-center">
                  <Sparkles className="w-5 h-5 text-white" />
                </div>
                <div>
                  <h2 className="text-[20px] font-semibold text-gray-900">AI Job Builder</h2>
                  <p className="text-[13px] text-gray-500">Tell me about the position and I'll create a compelling job posting</p>
                </div>
              </div>
              ...
              <div className="space-y-4 mb-6">
                {messages.map((msg, idx) => (
                  <div
                    ...
                    <div
                      className={`max-w-[75%] px-4 py-3 rounded-2xl text-[13px] ${
              ...
              {/* Input */}
              <div className="flex gap-2 bg-white rounded-xl border border-gray-200 p-4">
                <Textarea
                  value={input}
