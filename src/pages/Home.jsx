    ...
    <div className="bg-[#f2f3f5] px-6 py-6 h-full overflow-hidden flex flex-col">
      ...
      <div className="mb-6 pt-4 flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <button onClick={() => navigate(createPageUrl("Settings") + "?tab=integrations")} className="text-gray-700 px-4 py-2 text-xs font-medium rounded-lg hover:bg-gray-50 transition-colors flex items-center gap-2"><Mail className="w-4 h-4" /> Connect Email</button>
          <button onClick={() => navigate(createPageUrl("Settings") + "?tab=integrations")} className="text-gray-700 px-4 py-2 text-xs font-medium rounded-lg hover:bg-gray-50 transition-colors flex items-center gap-2"><Calendar className="w-4 h-4" /> Connect Calendar</button>
          <button onClick={() => navigate(createPageUrl("Settings") + "?tab=integrations")} className="text-gray-700 px-4 py-2 text-xs font-medium rounded-lg hover:bg-gray-50 transition-colors flex items-center gap-2">⚡ Integrated with Greenhouse</button>
        </div>
      </div>
...
function ApprovalItem({ item }) {
  return (
    <div className="bg-transparent p-3 rounded-xl flex items-start gap-3 hover:bg-gray-100/80 transition-colors duration-200 group">
      <div className="bg-orange-100 mt-0.5 rounded-[28px] w-8 h-8 flex items-center justify-center flex-shrink-0">
