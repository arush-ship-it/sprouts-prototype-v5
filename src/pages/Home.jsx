    ...
    <div className="bg-[#f2f3f5] px-6 py-6 min-h-screen">
      ...
      <div className="flex gap-6 items-stretch">
        ...
        <div className="w-[403px] shrink-0 flex flex-col gap-4">
          {/* Ad Banner */}
          <div className="rounded-2xl overflow-hidden shrink-0" style={{ background: "linear-gradient(135deg, #dbeafe 0%, #bfdbfe 60%, #93c5fd 100%)", border: "5px solid white" }}>
          ...
          {/* Recent Activity */}
          <div className="bg-white mt-2 p-5 rounded-xl border border-gray-100 shadow-sm flex flex-col flex-1 overflow-y-auto">
