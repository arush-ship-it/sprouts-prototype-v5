...
function AgentCard({ agent, onToggle, onClick }) {
  ...
  return (
    <div className="rounded-2xl bg-white border border-gray-200 hover:shadow-lg hover:border-gray-300 transition-all overflow-hidden">
      {/* Large Icon Area */}
      <div className="bg-[#F4FF75] pt-14 pb-20 px-4 from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center border-t-[16px] border-l-[16px] border-r-[16px] border-white">
      ...
      <div className="p-5">
        ...
        {/* Button */}
        <Button
          onClick={onClick} className="w-full bg-[#2563EB] text-white px-6 py-2 font-medium opacity-100 rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow hover:bg-[#1d4ed8] h-10">
