    ...
    <div className="flex-1 min-h-screen bg-[#FAFAFA]">
      <div className="bg-[#F2F3F5] pt-8 pb-6 px-8">
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="bg-slate-200 p-1 rounded-[10003px] flex items-center">
            {[
            ...
            <button
              key={key}
              onClick={() => setActiveTab(key)} className="px-5 py-1.5 text-xs font-medium rounded-full transition-all duration-200 bg-white text-gray-900">
