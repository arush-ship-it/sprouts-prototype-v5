    ...
    <div className="flex-1 min-h-screen bg-[#FAFAFA]">
      <div className="bg-[#F2F3F5] pt-8 pb-6 px-8">
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="p-1 rounded-[10003px] flex items-center">
            {[
          ...
          <div className="flex items-center gap-2">
              ...
              <div className="bg-gray-200 p-1 rounded-[32px] flex items-center">
                <button
                onClick={() => setViewMode("list")} className="bg-white text-gray-800 p-1.5 rounded-lg flex items-center justify-center transition-all duration-200 shadow-[0_1px_4px_rgba(0,0,0,0.12)]">
        ...
        <div className="flex flex-col gap-4 pb-4">
            ...
            const Icon = agent.icon;
            return (
              <div key={agent.id} className="bg-white rounded-2xl border border-gray-100 overflow-hidden flex">
      ...
      <SchedulingSetupModal isOpen={schedulingSetupOpen} onClose={() => setSchedulingSetupOpen(false)} />
